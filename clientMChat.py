...
encrypter = Encrypter(is_static_key=True)
...
while True:
    ...
    if is_private_chat_accepted is False:
        ...
        enc_message = encrypter.do_encrypt(message.encode('utf-8'))
    ...
    try:
        ...
        while True:
            ...
            if private_chat_username == username and is_private_chat_accepted is True:
                message = encrypter.do_decrypt(client_socket.recv(message_length))
